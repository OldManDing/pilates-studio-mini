...
assertIncludes('src/pages/courses/index.tsx', 'getCourseCoverImage(course)');
...
assertIncludes('src/pages/course-detail/index.tsx', 'preferredSessionId');
assertIncludes('src/pages/course-detail/index.tsx', 'isFeaturedSessionFull');
assertIncludes('src/pages/course-detail/index.tsx', 'getCourseCoverImage(matchedSession?.course)');
assertNotIncludes('src/pages/course-detail/index.tsx', 'sessionPickerOpen');
assertNotIncludes('src/pages/course-detail/index.tsx', '选择预约场次');
...
assertIncludes('src/pages/index/index.tsx', "case 'courses':");
assertIncludes('src/pages/index/index.tsx', 'handleBookingsEntry();');
...
assertIncludes('src/api/request.ts', 'authInteractive = false');
assertIncludes('src/api/request.ts', 'ensureMiniProgramAuth({ interactive: authInteractive })');
assertIncludes('src/api/request.ts', 'response.statusCode === 401');
